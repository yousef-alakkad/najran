        ...
        <td bgcolor="#f4f4f4" align="left" valign="top">
            <div
                ...
                <div style="font-size: 18px; color:#000; margin:8px 0 0;font-weight:bold;text-align:right">
                        ...
                        <br>
                        <br>
                        ننتظركم غداً باذن الله في ملتقى المهارات والتدريب وعد بمنطقة نجران في مركز  الأمير سلطان الحضاري بنجران
                        <br>
                        الساعه ١٠ صباحاً
                        <br>
                        <br>
                ...
                <br>
                <br>
                <a href="https://maps.app.goo.gl/gZRg9QWaAXPB7BLX6?g_st=ic" style="display:block;margin: 0 auto;width: fit-content;">
