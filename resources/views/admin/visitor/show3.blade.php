        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    <a href="{{ url('/export-all-registered?type=3') }}" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a>
                    <h6 class="m-0 font-weight-bold text-primary">
                        <a class="btn" data-toggle="modal" data-target="#exampleModal" style="font-weight:bold;float:right;font-size:1.2rem">
                            ...
                            <a href="{{ url('/admin/send-reminder/visitors/3') }}" class="btn btn-success">
                ...
                var table = $('.yajra-datatable').DataTable({
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            targets: 12,
                            render: function (data, type, full) {
                                let system = full['system'];
                                return system == 0 ? 'خارجي' : 'يدوي';
                            }
                        },
                        {
                            targets: -2,
