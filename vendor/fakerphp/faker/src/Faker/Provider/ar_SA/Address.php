...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $subdivisions = [
        ...
        'منطقة عسير', 'منطقة نجران', 'منطقة نجران', 'منطقة الباحة',
        'المنطقة الشرقية',
    ];
    ...
    protected static $governorates = [
        ...
        'نجران', 'صبيا', 'أبو عريش', 'صامطة', 'بيش', 'الدرب', 'الحرث', 'ضمد', 'الريث', 'جزر فرسان', 'الدائر', 'العارضة', 'أحد المسارحة', 'العيدابي', 'فيفاء', 'الطوال', 'هروب',
